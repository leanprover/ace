...
var leanHighlightRules = function() {
    ...
    var keywordControls = (
        ["import", "reducible", "irreducible", "tactic_hint", "protected",
         ...
         "with", "structure", "universe", "alias", "help", "environment",
         ...
         "add_rewrite", "extends"].join("|")
    );

    var storageType = (
        ["bool", "int", "nat", "real", "Prop", "Type", "ℕ", "ℤ"].join("|")
    );
    ...
    var keywordOperators = (
        ["calc", "have", "obtains", "show", "by", "in", "let",
        "forall", "fun", "exists", "if", "then", "else", "assume",
